...
class Trainer():
    def __init__(self, args):
        ...
        train_transform = transform_contour.Compose([
            ...
            transform_contour.Crop([448, 448], crop_type='rand', padding=mean, ignore_label=255),
        ...
        val_transform = transform.Compose([
            transform.Crop([448, 448], crop_type='center', padding=mean, ignore_label=255),
            transform.ToTensor(),
