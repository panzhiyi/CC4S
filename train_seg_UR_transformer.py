...
# mmconfig_file = 'configs/pspnet/pspnet_r50-d8_512x512_20k_voc12aug.py'
...
class Trainer():
    ...
    def train(self, epoch):
        ...
        for i, batch in enumerate(tbar):
            ...
            #print(pred_sg_up.shape,gt_v.squeeze(1).shape,edge_v.shape) #torch.Size([16, 21, 465, 465]) torch.Size([16, 465, 465]) torch.Size([16, 465, 465])
            loss_edge = 0
            ...
            if if_laplaceloss == 1:
                ...
                pred_sg_up2 = F.interpolate(pred2, size=input_size, mode='bilinear', align_corners=True)
                lploss = self.laplaceloss(pred_sg_up,pred_sg_up2.detach(),img_index1,img_index2)
